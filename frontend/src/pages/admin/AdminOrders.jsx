...
const PAYMENT_STATUS_MAP = {
  pending: { label: "Ожидает оплаты", color: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300" },
  paid:    { label: "Оплачен",        color: "bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300" },
  failed:  { label: "Не оплачен",     color: "bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300" },
};
